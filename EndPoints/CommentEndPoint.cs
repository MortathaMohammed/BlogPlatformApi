...
{
    public static async Task<IResult> GetCommentsByPost(Guid id, IUnitOfWork _unitOfWork)
    {
    ...
    public static async Task<IResult> DeleteComment(Guid id, IUnitOfWork _unitOfWork)
    {
